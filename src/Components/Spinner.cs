...
) : ComponentBase, IDisposable
{
	...
	private void RenderFrame(int frameIndex)
	{
		...
		renderer.WriteColored(_frames[frameIndex], ActiveTheme.Colors.Primary);

		if (!string.IsNullOrEmpty(Label))
		{
			renderer.WriteColored(" ", ActiveTheme.Colors.Muted);
			renderer.WriteColored(Label, ActiveTheme.Colors.Muted);
		}
